...
if __name__ == "__main__":
    ...
    xgb_model = xgb.XGBClassifier(use_label_encoder=False, objective='binary:logistic', learning_rate=0.05, random_state=42, booster='gbtree', reg_lambda=1.0)
    ...
    prob_dict['pred']   = y_pred_proba_xgb.tolist()
    with open("Path to save probabilities jsons/xgb.json", "w") as js:
